...
local M = {
    ...
    config = function()
        ...
        vim.api.nvim_command([[
            nnoremap <leader>ts :lua require('telescope').extensions.coc.workspace_symbols({winblend=25,layout_config={preview_width=0.6,width=0.75}})<cr>
            ...
            nnoremap <leader>tr :lua require('telescope').extensions.coc.references({winblend=15,layout_config={preview_width=0.6,width=0.75}})<cr>
            nnoremap <leader>tc :lua require('telescope').extensions.coc.commands({winblend=15,layout_config={width=0.6,width=0.75}})<cr>
            nnoremap <leader>ti :lua require('telescope').extensions.coc.implementations({winblend=15,layout_config={width=0.6,width=0.75}})<cr>
